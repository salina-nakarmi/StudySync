...
export default function AuthenticationPage() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // ALWAYS use signUp for OAuth - it handles both new users AND existing users
      // Clerk's signUp.authenticateWithRedirect automatically:
      // - Creates account if user doesn't exist
      // - Signs in if user already exists

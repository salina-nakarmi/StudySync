 ...
 *
 * Onboarding is intentionally explicit, not automatic — github_username
 * is optional but useful for linking commits to project members.
 */
export default function OnboardingPrompt() {
  const { onboard } = useTeamMember({ fetchProfile: false });
